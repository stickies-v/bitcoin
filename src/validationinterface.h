...
protected:
     ...
     */
    virtual void BlockChecked(std::shared_ptr<const CBlock>, const BlockValidationState&) {}
    /**
...
public:
    ...
    void BlockChecked(std::shared_ptr<const CBlock>, const BlockValidationState&);
