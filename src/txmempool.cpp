                                                  ...
                                                  std::string &errString) const
{
    ...
    while (!staged_ancestors.empty()) {
        ...
        if (stageit->GetSizeWithDescendants() + entry_size > limits.descendant_size_vbytes) {
            ...
            return false;
        } else if (stageit->GetCountWithDescendants() + entry_count > limits.descendant_count) {
        ...
        for (const CTxMemPoolEntry& parent : parents) {
            ...
            if (staged_ancestors.size() + setAncestors.size() + entry_count > limits.ancestor_count) {
