...
/** Forward declaration for btck_LogEntry (defined below with logging types) */
typedef struct btck_LogEntry btck_LogEntry;

/** Callback function types */

/**
 * Function signature for the logging callback. All bitcoin kernel
 ...
 * consumer to format and filter as needed. Category filtering should be
 * done in the callback - the kernel does not filter by category.
 *
...
/**
 * @brief Stop logging and destroy the logging connection.
 */
