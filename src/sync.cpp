...
{
    KernelLogInfo("POTENTIAL DEADLOCK DETECTED\n");
    KernelLogInfo("Previous lock order was:\n");
    ...
    KernelLogInfo("Current lock order is:\n");
...
{
    KernelLogInfo("DOUBLE LOCK DETECTED\n");
    KernelLogInfo("Lock order:\n");
...
void CheckLastCritical(void* cs, std::string& lockname, const char* guardname, const char* file, int line)
{
    ...
    KernelLogInfo("INCONSISTENT LOCK ORDER DETECTED\n");
    KernelLogInfo("Current lock order (least recent first) is:\n");
    for (const LockStackItem& i : lock_stack) {
        KernelLogInfo(" %s\n", i.second.ToString());
    }
    if (g_debug_lockorder_abort) {
